    ...
    public render() {
        ...
        return (
            ...
            >
                ...
                >
                    <Menu.Item  key='home' className={ active === 'home' ? "active" : ''}>
                        <Link to='/'>
                            <Icons type="iconmenu_home" className="iconmenu_home" />  
                            {mouseCover ? <span>首页</span> : ''}
                        </Link>
                    </Menu.Item>
                    <SubMenu key="sub1" title={<span><Icons type="iconmenu_finance" className="iconmenu_finance" /> 财务分析首页</span>}>
                        <Menu.Item  key='market' className={ active === 'market' ? "active" : ''}>
                            <Link to='/market'>
                                {mouseCover ? <span>财务分析首页</span> : ''}
                            </Link>
                        </Menu.Item>
                        <Menu.Item key='riskProfile' className={ active === 'riskProfile' ? "active" : ''}>
                            <Link to='/market/riskProfile'>
                                {mouseCover ? <span>财务风险概况</span> : ''}
                            </Link>
                        </Menu.Item>
                        <Menu.Item key='riskDetails' className={ active === 'riskDetails' ? "active" : ''}>
                            <Link to='/market/riskDetails'>
                                {mouseCover ? <span>财务风险详情</span> : ''}
                            </Link>
                        </Menu.Item>
                    </SubMenu>
                    <Menu.Item key='knowledge' className={ active === 'knowledge' ? "active" : ''}>
                        <Link to='/knowledge'>
                    ...
                    <Menu.Item key='enterprise' className={ active === 'enterprise' ? "active" : ''}>
                        <Link to='/enterprise'>
